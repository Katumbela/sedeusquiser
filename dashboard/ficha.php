...
<html lang="pt">
  <head>
    ...
    <title>Ficha de inscrição online | Se Deus Quiser</title>
  ...
  <div class="row ">
    ...
    <main class="col-md-11 w-100 ms-sm-auto col-lg-11">
      <div class="d-flex main justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Adicionar Estudante - Ficha Nº <?=$ficha?></h1>
                       ...
                       <fieldset>
                           <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="curso" placeholder="Curso a frequentar" id="curso" class="form-control">
                                <br>
                                <label for="duracao">Nome Completo <b class="text-danger">*</b></label>
                                <input type="text" name="dur" id="duracao" placeholder="Nome do formando" class="form-control">
                                <br>
                                <label for="duracao">Encarregado  <b class="text-danger">*</b></label>
                                <input type="text" name="dur" id="duracao" placeholder="Descrição/ uma frase sobre o curso" class="form-control">
                                <br>
                                <label for="duracao">Telefone   <b class="text-danger">*</b></label>
                                <input type="number" name="dur" id="duracao" placeholder="Telefone" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-6 col-md-6">
                              <div class="form-group">
                                ...
                                <label for="duracao">Morada  <b class="text-danger">*</b></label>
                                <input type="text" name="morada" id="Morada" placeholder="Morada do formando" class="form-control">
                                <br>
                                ...
                                <label for="int">Algun Desconto ? <span class="text-muted">(opcional)</span></label>
                                <select name="carga" id="int" class="form-control">
                                ...
                                <center><button class="btn botao-c" style=" border-radius: 20px; border: 1px solid #036318; color: white; background-color: #0066be;">submeter formando</button></center>
                            </div><br>
